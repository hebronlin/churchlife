# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-08-17 18:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Active', 'Active'), ('Inactive', 'Inactive'), ('Completed', 'Completed')], default='Active', max_length=30)),
                ('event_type', models.CharField(choices=[('Daily', 'Daily'), ('Weekly', 'Weekly'), ('Monthly', 'Monthly'), ('Yearly', 'Yearly')], default='Weekly', max_length=30)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, help_text='The date when this record was created.')),
                ('last_updated', models.DateTimeField(auto_now=True, help_text='The date when this record was last updated.')),
                ('member_type', models.CharField(choices=[('Member', 'Member'), ('Guest', 'Guest'), ('ReportAdmin', 'ReportAdmin'), ('Admin', 'Admin')], default='Member', max_length=50)),
