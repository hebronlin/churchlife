# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-07-19 21:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Junior High', 'Junior High'), ('High School', 'High School'), ('College Student', 'College Student'), ('Full-timer', 'Full-timer'), ('Working Saint', 'Working Saint'), ('Others', 'Others')], default='Others', max_length=50)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateTimeField(auto_now=True, help_text='The date when this record was last updated.')),
                ('date', models.DateField()),
                ('reason', models.CharField(choices=[('Unknown', 'Unknown'), ('Sick', 'Sick'), ('In Service', 'In Service'), ('Travel', 'Travel')], default='Unknown', max_length=50)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, help_text='The date when this record was created.')),
                ('last_updated', models.DateTimeField(auto_now=True, help_text='The date when this record was last updated.')),
                ('member_type', models.CharField(choices=[('Member', 'Member'), ('Guest', 'Guest'), ('Admin', 'Admin')], default='Member', max_length=50)),
        ...
        migrations.AddField(
            model_name='address',
            name='created',
            field=models.DateTimeField(auto_now_add=True, default=datetime.datetime(2016, 7, 19, 21, 18, 33, 869497, tzinfo=utc), help_text='The date when this record was created.'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='address',
            name='last_updated',
            field=models.DateTimeField(auto_now=True, default=datetime.datetime(2016, 7, 19, 21, 18, 47, 481838, tzinfo=utc), help_text='The date when this record was last updated.'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='event',
            name='created',
            field=models.DateTimeField(auto_now_add=True, default=datetime.datetime(2016, 7, 19, 21, 19, 6, 735984, tzinfo=utc), help_text='The date when this record was created.'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='event',
            name='description',
            field=models.CharField(default=datetime.datetime(2016, 7, 19, 21, 19, 11, 173095, tzinfo=utc), max_length=500),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='event',
            name='last_updated',
            field=models.DateTimeField(auto_now=True, default=datetime.datetime(2016, 7, 19, 21, 19, 16, 421929, tzinfo=utc), help_text='The date when this record was last updated.'),
            preserve_default=False,
        ),
