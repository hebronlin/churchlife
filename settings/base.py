"""
Django settings for churchlife project.
...
SECRET_KEY = '5a!hukw14^^w+gtbu$g%)%e$*b+9_y9!d4%ujdbmwt4#_&k&y0'
...
WSGI_APPLICATION = 'churchlife.core.wsgi.application'
